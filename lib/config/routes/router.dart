...
import 'package:yucat/features/articles/presentation/article_detail_page.dart';
import 'package:yucat/features/articles/presentation/articles_page.dart';
...
import 'package:yucat/features/food_guide/presentation/food_guide_page.dart';
...
class AppRouter extends RootStackRouter {
  ...
  List<AutoRoute> get routes => [
    ...
    AutoRoute(page: ArticleDetailRoute.page, path: '/article-detail'),
    AutoRoute(page: FoodGuideRoute.page, path: '/food-guide'),
