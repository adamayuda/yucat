...
class AppLocalizationsPt extends AppLocalizations {
  ...
  @override
  String get paywallLimitedTimeOffer => 'Oferta por tempo limitado';

  @override
  String paywallLimitedTimeOfferWithSavings(String savings) {
    return 'Oferta por tempo limitado · $savings';
  }
  ...
  String get paywallAutoRenewDisclosure =>
      'A sua subscrição renova-se automaticamente, a menos que a cancele pelo menos 24 horas antes do final do período em vigor. Cancele quando quiser na App Store sem custos adicionais.';
  ...
  @override
  String get homeAddCatTitle => 'Adicione o seu gato';

  @override
  String get homeAddCatBody =>
      'Crie um perfil para obter pontuações personalizadas.';
  ...
  @override
  String get bottomNavSearch => 'Pesquisar';
  ...
  String onboardingBrandUnlockCta(String name) {
    return 'Desbloquear as melhores opções do $name';
  }
  ...
  @override
  String get onboardingScanCta => 'Digitalizar a embalagem';
