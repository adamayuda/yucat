...
///
/// ⚠️ Deliberately does **not** request the native review popup any more.
/// Apple allows 3 per 365 days, and spending one here — before the user has
/// scanned anything — cost a slot on every new user at the lowest-intent
/// moment. The ask lives in `ReviewPromptService`, after real value.
