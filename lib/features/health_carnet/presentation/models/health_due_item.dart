...
enum HealthUrgency {
  ...
  String get wire => switch (this) {
        HealthUrgency.overdue => 'overdue',
        HealthUrgency.urgent => 'urgent',
        HealthUrgency.soon => 'soon',
        HealthUrgency.later => 'later',
        HealthUrgency.toSchedule => 'to_schedule',
      };
}
...
class HealthDueItem {
  ...
  /// The record this was computed from, if any. Null when nothing has been
  /// recorded for this protocol yet — which is [HealthUrgency.toSchedule] once
  /// the act applies, but an ordinary future item for a cat that has not grown
  /// into it.
