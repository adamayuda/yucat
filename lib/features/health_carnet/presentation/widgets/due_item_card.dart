...
/// The urgency tag — shared with Home's next-up card so the two surfaces
/// name and colour an item identically.
class HealthUrgencyPill extends StatelessWidget {
  final HealthDueItem item;

  const HealthUrgencyPill({super.key, required this.item});
